            ...
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                    <div class="modal-header">
                        ...
                        <h4 class="modal-title" id="editQuizModalLabel">Edit Quiz</h4>
                    </div>
                    <div class="modal-body">
                        <form id="editQuizForm" method="post" action="editQuiz">
                            ...
                            <button type="button" class="btn btn-primary" id="saveQuiz">Save changes</button>
                        </form>
                    </div>
